    ...
    <GuestLayout>
        ...
        >
            ...
            <div
                ...
                :class="
                    isDark
                        ? 'bg-gradient-to-r from-[#FF9500] via-[#00A3FF] to-transparent'
                        : 'bg-gradient-to-r from-[#FF9500] via-[#ffd699] to-transparent'
                "
            ></div>

            <!-- LEFT ARTWORK SIDE -->
            <div
                class="login-art-panel relative w-full md:w-1/2 min-h-[350px] md:min-h-[600px] overflow-hidden select-none"
            >
                ...
                <div
                    class="absolute bottom-0 left-0 p-8 space-y-3 z-20 hidden md:block"
                >
                    <span
                    ...
                    >
                        Bienvenue chez les Guepards
                    </span>
                    <h4
                        class="art-overlay-stagger text-xl font-black text-white uppercase tracking-tight drop-shadow-lg"
                    >
                        Dominez le Classement
                    </h4>
                    <p
                        class="art-overlay-stagger text-[10px] text-white/60 font-semibold tracking-wider flex items-center gap-1.5 drop-shadow-md"
                    >
                        <i class="pi pi-compass animate-spin-slow"></i> Résolvez
                        des énigmes d'Abomey à Ganvié !
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <div class="login-stagger mb-8 space-y-2">
                    ...
                    >
                        Prêt à percer les mystères de Ouidah, à voguer sur
                        Ganvié ou à braver les énigmes de Dassa ? Entrez dans le
                        jeu !
                    </p>
                </div>
                ...
                <div
                    v-if="status"
                    class="mb-4 p-4 bg-green-500/10 border border-green-500/20 text-xs font-bold text-green-400 rounded-2xl"
                >
                    {{ status }}
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="login-stagger space-y-2">
                        <InputLabel
                            for="email"
                            value="Identifiant Aventurier (Email)"
                            :class="
                                isDark ? 'text-white/50' : 'text-[#1c1917]/50'
                            "
                            ...
                            <span
                                :class="
                                    isDark
                                        ...
                                        : 'text-[#1c1917]/30'
                                "
                                class="absolute inset-y-0 left-0 pl-4 flex items-center transition-colors duration-500"
                            >
                    ...
                    <div class="login-stagger space-y-2">
                        <InputLabel
                            for="password"
                            value="Clé Secrète (Mot de passe)"
                            :class="
                                isDark ? 'text-white/50' : 'text-[#1c1917]/50'
                            "
                            class="text-[9px] font-black uppercase tracking-[0.2em] transition-colors duration-500"
                    ...
                    <div
                        class="login-stagger flex items-center justify-between pt-1"
                    >
                        <label
                            ...
                            <span
                                :class="
                                    isDark
                                        ...
                                        : 'text-[#1c1917]/40 group-hover:text-[#1c1917]/70'
                                "
                                class="ms-2 text-[10px] font-black uppercase tracking-wider transition-all duration-300"
